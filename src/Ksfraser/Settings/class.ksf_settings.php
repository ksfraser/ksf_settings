...
/************************************//**
* Module for stashing settings into a SESSION variable.
*
********************************************************/

class ksf_settings extends origin
{
    	/***************************************************************//**
         *build_interestedin
         *
		...
		echo get_class( $this ) . "::" . __METHOD__ . "\n\r";
                $this->interestedin['SETTINGS_SAVE']['function'] = "settings_save";
                $this->interestedin['SETTINGS_QUERY']['function'] = "settings_query";
	...
	* @return bool
	******************************************************/
	function settings_save( $caller, $msg )
	{
		echo get_class( $this ) . "::" . __METHOD__ . "\n\r";
		var_dump( $msg );
		if( is_array( $msg ) )
	...
	* @returns bool
	**************************************************/
	function settings_query( $caller, $msg )
	{
		echo get_class( $this ) . "::" . __METHOD__ . "\n\r";
		if( isset( $_SESSION['settings'][$msg] ) )
		{
			$value =  $_SESSION['settings'][$msg] ;
		}
		else
		{
